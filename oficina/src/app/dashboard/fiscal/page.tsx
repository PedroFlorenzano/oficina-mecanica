        ...
        {tab === "nfse" && (
          <Card className="p-6">
            ...
            <div className="space-y-6">
              ...
              <fieldset className="border border-slate-200 rounded-lg p-4">
                <legend className="text-sm font-semibold text-green-600 px-2">Emissão — Padrão Nacional</legend>
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                  <span>NFS-e será emitida via <strong>SEFIN Nacional (ADN)</strong> — cobertura em todo o Brasil.</span>
                </div>
                <p className="text-xs text-slate-500 mt-2 ml-7">Obrigatório desde 01/01/2026 (LC 214/2025). Apenas o certificado digital A1 e o código IBGE do município são necessários.</p>
              </fieldset>
            </div>
          </Card>
        )}
