...
export default withAuth(
  function middleware(req) {
    ...
    if (pathname.startsWith("/api/") && !pathname.startsWith("/api/auth/") && !pathname.startsWith("/api/public/") && !pathname.startsWith("/api/whatsapp/webhook") && !pathname.startsWith("/api/whatsapp/reminders") && !token) {
