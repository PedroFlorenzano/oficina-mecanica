...
export default withAuth(
  function middleware(req) {
    ...
    if (pathname.startsWith("/api/") && !pathname.startsWith("/api/auth/") && !pathname.startsWith("/api/public/") && !pathname.startsWith("/api/whatsapp/webhook") && !pathname.startsWith("/api/whatsapp/reminders") && !pathname.startsWith("/api/billing/webhook") && !pathname.startsWith("/api/admin/reset-password") && !token) {
